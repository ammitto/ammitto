...
module Ammitto
  module Sources
    module Cn
      # AntiSanctionsScraper fetches and parses China MFA Anti-Sanctions notices
      #
      ...
      #
      # @example
      #   scraper = Ammitto::Sources::Cn::AntiSanctionsScraper.new(verbose: true)
      #   entities = scraper.fetch_and_parse
      #
      class AntiSanctionsScraper
        # Index page URL
        ...
        def fetch_and_parse_notice(url)
          ...
          parser = NoticeParser.new(content)
      ...
      # NoticeParser parses individual MFA anti-sanctions notices
      #
      class NoticeParser
        ...
        def extract_entity_names
          ...
          content.scan(english_pattern) do |match|
            ...
            unless entities.any? { |e| e[:full_name] == match }
              entities << {
