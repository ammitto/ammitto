...
require_relative 'measure_modification'
require_relative 'document_types_source'
require_relative 'organizations_source'
require_relative 'transformer'

module Ammitto
  module Sources
    module Cn
      # Source handles China (MOFCOM/MFA) sanctions data
      #
      ...
      #
      # @example
      #   source = Ammitto::Sources::Cn::Source.new
...
# Register the source
Ammitto::Registry.register(:cn, Ammitto::Sources::Cn::Source)
