...
module Ammitto
  module Sources
    module Cn
      # AnnouncementParser parses China MOFCOM sanctions announcements
      #
      ...
      #
      # @example
      #   parser = Ammitto::Sources::Cn::AnnouncementParser.new(content)
      #   entities = parser.parse
      #   # => [{ full_name: "Lockheed Martin", script: "Latn", ... }]
      #
