...
module Ammitto
  module Data
    module Japan
      ...
      # 2. Check by directory path (legal-instruments, sanction-lists)
      # 3. Check by content structure (sanction_details, measure_modifications)
      #
      # @example Resolving schema type
      #   type = SchemaResolver.resolve('sources/sanction-lists/mof/file.yml')
      #   # => :announcement
      #
      #   type = SchemaResolver.resolve('sources/legal-instruments/fefta.yml', content)
      #   # => :legal_instrument
      #
      class SchemaResolver
        ...
        class << self
          ...
          # Check if content has sanction_details key (announcement)
